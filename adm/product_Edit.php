...
if (isset($_POST['edit_product'])) {
    ...
    $query = "UPDATE products SET product_name = '$product_title' ,product_img ='$product_image', product_desc = '$product_desc', product_info = '$product_info', product_price = '$product_price'  WHERE product_id = $p_id ";
...
?>
            ...
            <div class="container-add">
                ...
                <!-- /.row -->
             <form action="product_edit.php?edit=<?php echo $p_id ?>" method="post" enctype="multipart/form-data">    
