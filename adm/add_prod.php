...
if (isset($_POST['add_product'])) {
    ...
    $query = "INSERT INTO Products(product_name,product_desc,product_img,product_info,product_price) VALUES ('$product_title','$product_desc','$product_image','$product_info',$product_price)";
